...
Create a new [sandbox](https://sinonjs.org/concepts/sandboxes/create-sandbox) instead of using the default one.
...
Use Sinon's built-in [assertions](https://sinonjs.org/concepts/assertions/) to display more robust error messages.
...
Use [matchers](https://sinonjs.org/concepts/matchers/) to match partial object.
